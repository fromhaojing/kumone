...
enum ReleaseChecker {
    ...
    static let releasesPage = URL(string: "https://github.com/fromhaojing/Tinglan/releases/latest")!
    ...
    static func latest() async throws -> Release {
        var request = URLRequest(url: URL(string: "https://api.github.com/repos/fromhaojing/Tinglan/releases/latest")!)
